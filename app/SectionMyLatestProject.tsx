                                    ...
                                    tab.data.map((item, dataIndex) =>
                                        activeTab === tabIndex && (
                                            ...
                                            >
                                                ...
                                                <div className='absolute top-0 bottom-0 left-0 right-0 hidden transition-all duration-300 gap-y-2 group-hover:block bg-gray/10 text-accent backdrop-blur-sm rounded-2xl'>
